	...
	public PanelFormulario() {
		...
		esCiudadano.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent actionEvent) {
				boolean isTicked = esCiudadano.isSelected();
				etiquetaTexto.setEnabled(isTicked);
				campoTexto.setEnabled(isTicked);
			}
		});
		...
		botonOk.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				EventoFormulario ev = new EventoFormulario(
						this, nombre, ocupacion, categoriaEdad.getId(), categoriaEmpleado, taxId, usCitizen);
