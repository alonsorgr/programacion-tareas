...
public class Tarro {
    ...
    static {
        ...
        // EJEMPLO ORDEN EJECUCIÓN
        System.out.println("INICIO BLOQUE DE INICIALIZACION ESTATICO");
        System.out.println(Arrays.toString(aceitunas1));
     ...
     */
    {
        ...
        // EJEMPLO ORDEN EJECUCIÓN
        System.out.println("INICIO DE BLOQUE DE INSTANCIA");
        System.out.println(Arrays.toString(aceitunas2));
    }
