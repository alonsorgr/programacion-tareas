...
public class Ventana extends JFrame {
    ...
    public Ventana(String tituloVentana, String titulo, String textoBoton, String etiquetaUsuario,
        ...
        add(panelAyuda(info1, info2, icono),
                BorderLayout.SOUTH);
        setPropiedades();
    }
    ...
    private JPanel panelTitulo(String titulo) {
        ...
        icono.setIcon(new ImageIcon(getClass().getResource("/iesdonana/gui/imagenes/candado.png")));
    ...
    private JPanel panelDatos(String textoBoton, String texto, String etiquetaTextoClave, String textoCheckbox) {
        ...
        JCheckBox mostrarClave = new JCheckBox(textoCheckbox);
    ...
    private JPanel panelAyuda(String textoEnlace1, String textoEnlace2, String icono) {
        ...
        lIcono.setIcon(new ImageIcon(getClass().getResource("/iesdonana/gui/imagenes/" + icono + ".png")));
